...
Z80EX_BYTE port_mz1500_read_cb ( Z80EX_CONTEXT *cpu, Z80EX_WORD port, void *user_data ) {
...
/* z80ex_pwrite_cb */
void port_mz1500_write_cb ( Z80EX_CONTEXT *cpu, Z80EX_WORD port, Z80EX_BYTE value, void *user_data ) {
    ...
    switch ( port_lsb ) {
        ...
        case 0xe6:
            ...
            memory_mz1500_map_pwrite ( port_lsb, value );
            break;
        ...
        case 0xf0:
        case 0xf1:
            gdg_mz1500_write_byte ( port_lsb, value );
            break;

        case 0xe9:
            psg_write_byte ( &g_psgR, value );
        case 0xf2:
            psg_write_byte ( &g_psgL, value );
            break;
