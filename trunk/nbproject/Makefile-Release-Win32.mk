...
${OBJECTDIR}/src/ui/vkbd/ui_vkbd_autotype.o: src/ui/vkbd/ui_vkbd_autotype.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/vkbd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X86 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/vkbd/ui_vkbd_autotype.o src/ui/vkbd/ui_vkbd_autotype.c
