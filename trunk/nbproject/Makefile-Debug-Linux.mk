...
${OBJECTDIR}/src/fs_layer.o: src/fs_layer.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fs_layer.o src/fs_layer.c
...
${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_CGROM.o: src/memory/ROM/JSS-1.3/ROM_JSS103_CGROM.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_CGROM.o src/memory/ROM/JSS-1.3/ROM_JSS103_CGROM.c

${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_MZ700.o: src/memory/ROM/JSS-1.3/ROM_JSS103_MZ700.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.3
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_MZ700.o src/memory/ROM/JSS-1.3/ROM_JSS103_MZ700.c

${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_MZ800.o: src/memory/ROM/JSS-1.3/ROM_JSS103_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.3
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.3/ROM_JSS103_MZ800.o src/memory/ROM/JSS-1.3/ROM_JSS103_MZ800.c
...
${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_CGROM.o: src/memory/ROM/JSS-1.5C/ROM_JSS105C_CGROM.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_CGROM.o src/memory/ROM/JSS-1.5C/ROM_JSS105C_CGROM.c

${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ700.o: src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ700.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.5C
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ700.o src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ700.c

${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ800.o: src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.5C
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ800.o src/memory/ROM/JSS-1.5C/ROM_JSS105C_MZ800.c
...
${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_CGROM.o: src/memory/ROM/JSS-1.6A/ROM_JSS106A_CGROM.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_CGROM.o src/memory/ROM/JSS-1.6A/ROM_JSS106A_CGROM.c

${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ700.o: src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ700.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.6A
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ700.o src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ700.c

${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ800.o: src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.6A
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ800.o src/memory/ROM/JSS-1.6A/ROM_JSS106A_MZ800.c
...
${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_CGROM.o: src/memory/ROM/JSS-1.8C/ROM_JSS108C_CGROM.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_CGROM.o src/memory/ROM/JSS-1.8C/ROM_JSS108C_CGROM.c

${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ700.o: src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ700.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.8C
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ700.o src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ700.c

${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ800.o: src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/JSS-1.8C
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ800.o src/memory/ROM/JSS-1.8C/ROM_JSS108C_MZ800.c
...
${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_MZ700.o: src/memory/ROM/WILLY/ROM_WILLY_MZ700.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_MZ700.o src/memory/ROM/WILLY/ROM_WILLY_MZ700.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_en_CGROM.o: src/memory/ROM/WILLY/ROM_WILLY_en_CGROM.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_en_CGROM.o src/memory/ROM/WILLY/ROM_WILLY_en_CGROM.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_en_MZ800.o: src/memory/ROM/WILLY/ROM_WILLY_en_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_en_MZ800.o src/memory/ROM/WILLY/ROM_WILLY_en_MZ800.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_ge_CGROM.o: src/memory/ROM/WILLY/ROM_WILLY_ge_CGROM.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_ge_CGROM.o src/memory/ROM/WILLY/ROM_WILLY_ge_CGROM.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_ge_MZ800.o: src/memory/ROM/WILLY/ROM_WILLY_ge_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_ge_MZ800.o src/memory/ROM/WILLY/ROM_WILLY_ge_MZ800.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_jap_CGROM.o: src/memory/ROM/WILLY/ROM_WILLY_jap_CGROM.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_jap_CGROM.o src/memory/ROM/WILLY/ROM_WILLY_jap_CGROM.c

${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_jap_MZ800.o: src/memory/ROM/WILLY/ROM_WILLY_jap_MZ800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM/WILLY
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM/WILLY/ROM_WILLY_jap_MZ800.o src/memory/ROM/WILLY/ROM_WILLY_jap_MZ800.c
...
${OBJECTDIR}/src/memory/rom.o: src/memory/rom.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/rom.o src/memory/rom.c
...
${OBJECTDIR}/src/qdisk/qdisk.o: src/qdisk/qdisk.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/qdisk/qdisk.o src/qdisk/qdisk.c
...
${OBJECTDIR}/src/ui/ui_fcbutton.o: src/ui/ui_fcbutton.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_fcbutton.o src/ui/ui_fcbutton.c
...
${OBJECTDIR}/src/ui/ui_qdisk.o: src/ui/ui_qdisk.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_qdisk.o src/ui/ui_qdisk.c
...
${OBJECTDIR}/src/ui/ui_rom.o: src/ui/ui_rom.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -DMZ800_DEBUGGER -D_XOPEN_SOURCE=500 -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_rom.o src/ui/ui_rom.c
