...
${OBJECTDIR}/src/cmt/cmt_save.o: src/cmt/cmt_save.c 
	${MKDIR} -p ${OBJECTDIR}/src/cmt
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cmt/cmt_save.o src/cmt/cmt_save.c

${OBJECTDIR}/src/cmt/cmt_tap.o: src/cmt/cmt_tap.c 
	${MKDIR} -p ${OBJECTDIR}/src/cmt
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cmt/cmt_tap.o src/cmt/cmt_tap.c
...
${OBJECTDIR}/src/gdg/framebuffer_mz1500.o: src/gdg/framebuffer_mz1500.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/framebuffer_mz1500.o src/gdg/framebuffer_mz1500.c

${OBJECTDIR}/src/gdg/framebuffer_mz700.o: src/gdg/framebuffer_mz700.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/framebuffer_mz700.o src/gdg/framebuffer_mz700.c

${OBJECTDIR}/src/gdg/framebuffer_mz800.o: src/gdg/framebuffer_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/framebuffer_mz800.o src/gdg/framebuffer_mz800.c
...
${OBJECTDIR}/src/gdg/gdg_mz1500.o: src/gdg/gdg_mz1500.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/gdg_mz1500.o src/gdg/gdg_mz1500.c

${OBJECTDIR}/src/gdg/gdg_mz800.o: src/gdg/gdg_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/gdg_mz800.o src/gdg/gdg_mz800.c

${OBJECTDIR}/src/gdg/hwscroll_mz800.o: src/gdg/hwscroll_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/hwscroll_mz800.o src/gdg/hwscroll_mz800.c

${OBJECTDIR}/src/gdg/vramctrl_mz1500.o: src/gdg/vramctrl_mz1500.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/vramctrl_mz1500.o src/gdg/vramctrl_mz1500.c

${OBJECTDIR}/src/gdg/vramctrl_mz800.o: src/gdg/vramctrl_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src/gdg
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gdg/vramctrl_mz800.o src/gdg/vramctrl_mz800.c
...
${OBJECTDIR}/src/libs/dsk/dsk.o: src/libs/dsk/dsk.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/dsk/dsk.o src/libs/dsk/dsk.c

${OBJECTDIR}/src/libs/dsk/dsk_tools.o: src/libs/dsk/dsk_tools.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs/dsk
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/dsk/dsk_tools.o src/libs/dsk/dsk_tools.c

${OBJECTDIR}/src/libs/endianity/endianity.o: src/libs/endianity/endianity.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs/endianity
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/endianity/endianity.o src/libs/endianity/endianity.c
...
${OBJECTDIR}/src/libs/generic_driver/generic_driver.o: src/libs/generic_driver/generic_driver.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/generic_driver/generic_driver.o src/libs/generic_driver/generic_driver.c

${OBJECTDIR}/src/libs/mzf/mzf.o: src/libs/mzf/mzf.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs/mzf
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/mzf/mzf.o src/libs/mzf/mzf.c
...
${OBJECTDIR}/src/libs/mztape/cmtspeed.o: src/libs/mztape/cmtspeed.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/mztape/cmtspeed.o src/libs/mztape/cmtspeed.c
...
${OBJECTDIR}/src/libs/qd/qd.o: src/libs/qd/qd.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/qd/qd.o src/libs/qd/qd.c

${OBJECTDIR}/src/libs/wav/wav.o: src/libs/wav/wav.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs/wav
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/wav/wav.o src/libs/wav/wav.c

${OBJECTDIR}/src/libs/zxtape/zxtape.o: src/libs/zxtape/zxtape.c 
	${MKDIR} -p ${OBJECTDIR}/src/libs/zxtape
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/libs/zxtape/zxtape.o src/libs/zxtape/zxtape.c
...
${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_0000.o: src/memory/ROM_MZ1500/ROM_MZ1500_0000.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_0000.o src/memory/ROM_MZ1500/ROM_MZ1500_0000.c

${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_CGROM.o: src/memory/ROM_MZ1500/ROM_MZ1500_CGROM.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM_MZ1500
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_CGROM.o src/memory/ROM_MZ1500/ROM_MZ1500_CGROM.c

${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_E000.o: src/memory/ROM_MZ1500/ROM_MZ1500_E000.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory/ROM_MZ1500
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/ROM_MZ1500/ROM_MZ1500_E000.o src/memory/ROM_MZ1500/ROM_MZ1500_E000.c

${OBJECTDIR}/src/memory/memext.o: src/memory/memext.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/memext.o src/memory/memext.c
...
${OBJECTDIR}/src/memory/memory_mz1500.o: src/memory/memory_mz1500.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/memory_mz1500.o src/memory/memory_mz1500.c

${OBJECTDIR}/src/memory/memory_mz800.o: src/memory/memory_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src/memory
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory/memory_mz800.o src/memory/memory_mz800.c
...
${OBJECTDIR}/src/port_mz1500.o: src/port_mz1500.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/port_mz1500.o src/port_mz1500.c

${OBJECTDIR}/src/port_mz800.o: src/port_mz800.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/port_mz800.o src/port_mz800.c
...
${OBJECTDIR}/src/ui/debugger/ui_dbg_color_selection_dialog.o: src/ui/debugger/ui_dbg_color_selection_dialog.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/debugger
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/debugger/ui_dbg_color_selection_dialog.o src/ui/debugger/ui_dbg_color_selection_dialog.c
...
${OBJECTDIR}/src/ui/debugger/ui_dissassembler.o: src/ui/debugger/ui_dissassembler.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/debugger
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/debugger/ui_dissassembler.o src/ui/debugger/ui_dissassembler.c

${OBJECTDIR}/src/ui/debugger/ui_membrowser.o: src/ui/debugger/ui_membrowser.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/debugger
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/debugger/ui_membrowser.o src/ui/debugger/ui_membrowser.c

${OBJECTDIR}/src/ui/debugger/ui_memload.o: src/ui/debugger/ui_memload.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/debugger
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/debugger/ui_memload.o src/ui/debugger/ui_memload.c

${OBJECTDIR}/src/ui/debugger/ui_memsave.o: src/ui/debugger/ui_memsave.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/debugger
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/debugger/ui_memsave.o src/ui/debugger/ui_memsave.c
...
${OBJECTDIR}/src/ui/generic_driver/ui_file_driver.o: src/ui/generic_driver/ui_file_driver.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/generic_driver/ui_file_driver.o src/ui/generic_driver/ui_file_driver.c

${OBJECTDIR}/src/ui/generic_driver/ui_memory_driver.o: src/ui/generic_driver/ui_memory_driver.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/generic_driver
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/generic_driver/ui_memory_driver.o src/ui/generic_driver/ui_memory_driver.c

${OBJECTDIR}/src/ui/tools/ui_tool_pixbuf.o: src/ui/tools/ui_tool_pixbuf.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/tools
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/tools/ui_tool_pixbuf.o src/ui/tools/ui_tool_pixbuf.c
...
${OBJECTDIR}/src/ui/ui_file_chooser.o: src/ui/ui_file_chooser.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_file_chooser.o src/ui/ui_file_chooser.c
...
${OBJECTDIR}/src/ui/ui_memext.o: src/ui/ui_memext.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_memext.o src/ui/ui_memext.c
...
${OBJECTDIR}/src/ui/ui_unicard.o: src/ui/ui_unicard.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_unicard.o src/ui/ui_unicard.c
...
${OBJECTDIR}/src/ui/ui_version_check.o: src/ui/ui_version_check.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/ui_version_check.o src/ui/ui_version_check.c
...
${OBJECTDIR}/src/ui/vkbd/ui_vkbd_linux_x11.o: src/ui/vkbd/ui_vkbd_linux_x11.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/vkbd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/vkbd/ui_vkbd_linux_x11.o src/ui/vkbd/ui_vkbd_linux_x11.c

${OBJECTDIR}/src/ui/vkbd/ui_vkbd_windows.o: src/ui/vkbd/ui_vkbd_windows.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/vkbd
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/vkbd/ui_vkbd_windows.o src/ui/vkbd/ui_vkbd_windows.c

${OBJECTDIR}/src/unicard/MGR_MZF.o: src/unicard/MGR_MZF.c 
	${MKDIR} -p ${OBJECTDIR}/src/unicard
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/unicard/MGR_MZF.o src/unicard/MGR_MZF.c

${OBJECTDIR}/src/unicard/MZFLOADER_MZQ.o: src/unicard/MZFLOADER_MZQ.c 
	${MKDIR} -p ${OBJECTDIR}/src/unicard
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/unicard/MZFLOADER_MZQ.o src/unicard/MZFLOADER_MZQ.c

${OBJECTDIR}/src/unicard/unicard.o: src/unicard/unicard.c 
	${MKDIR} -p ${OBJECTDIR}/src/unicard
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/unicard/unicard.o src/unicard/unicard.c

${OBJECTDIR}/src/unicard/unimgr.o: src/unicard/unimgr.c 
	${MKDIR} -p ${OBJECTDIR}/src/unicard
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/unicard/unimgr.o src/unicard/unimgr.c

${OBJECTDIR}/src/version_check/version_check.o: src/version_check/version_check.c 
	${MKDIR} -p ${OBJECTDIR}/src/version_check
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/version_check/version_check.o src/version_check/version_check.c

${OBJECTDIR}/src/version_check/version_xml_parser.o: src/version_check/version_xml_parser.c 
	${MKDIR} -p ${OBJECTDIR}/src/version_check
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Wall -DWINDOWS -DWINDOWS_X64 -D_XOPEN_SOURCE=500 -Dmain=SDL_main -I. -Isrc -Isrc/z80ex -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/version_check/version_xml_parser.o src/version_check/version_xml_parser.c
