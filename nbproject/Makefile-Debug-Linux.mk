...
${OBJECTDIR}/src/ui/vkbd/ui_vkbd_autotype.o: src/ui/vkbd/ui_vkbd_autotype.c 
	${MKDIR} -p ${OBJECTDIR}/src/ui/vkbd
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -DLINUX -D_REENTRANT -D_XOPEN_SOURCE=500 -I. -Isrc -Isrc/z80ex/ -Isrc/z80ex/include -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ui/vkbd/ui_vkbd_autotype.o src/ui/vkbd/ui_vkbd_autotype.c
